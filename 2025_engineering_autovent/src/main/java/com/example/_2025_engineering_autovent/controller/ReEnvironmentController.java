...
import com.example._2025_engineering_autovent.dto.ReEnvironmentSettingRequest;
import com.example._2025_engineering_autovent.dto.ReEnvironmentSettingResponse;
...
public class ReEnvironmentController {
    ...
    public ResponseEntity<?> setEnvironment(@RequestBody ReEnvironmentSettingRequest req) {
        ...
        if (locationOpt.isPresent() && windowOpt.isPresent()) {
            // 성공 응답
            ReEnvironmentSettingResponse.Data d = new ReEnvironmentSettingResponse.Data();
            ...
            ReEnvironmentSettingResponse res = new ReEnvironmentSettingResponse();
            res.setStatus(200);
            res.setSuccess(true);
